...
stMixEM01Switch <- function(Y,p1,mu1,sigma1,nu1,gamma2,mu2,sigma2,nu2,nustar,maxiter)
{
  p2 <- 1 - p1
  n <- length(Y)
  nit <- 1
  ...
  while (2>1)
  {
    ...
    if (nu1>=nustar)
    {
      results <- list(p=p1,post=post1,mu1=mu1,sigma1=sigma1,nu1=Inf,
